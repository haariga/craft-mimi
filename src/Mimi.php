    ...
    public function init()
    {
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['siteActionTrigger1'] = 'mimi/default';
            }
        );
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['cpActionTrigger1'] = 'mimi/default/do-something';
            }
        );
        ...
        Event::on(
            ...
            function (RegisterComponentTypesEvent $event) {
                $event->types[] = MimiFieldField::class;
            }
        );
        ...
        Event::on(
            ...
            function (Event $event) {
                ...
                $variable->set('mimi', MimiVariable::class);
            }
        );
